...
open class CharacterShootingHandler(
    ...
    private fun handleAutoAim(transform: Matrix4, aimingRestriction: com.gadarts.returnfire.ecs.systems.character.factories.AimingRestriction?): Entity? {
    ...
    private fun findClosestAliveCharacter(
        ...
        aimingRestriction: com.gadarts.returnfire.ecs.systems.character.factories.AimingRestriction?
    ): Entity? {
        var closestCharacter: Entity? = null
        ...
        for (i in 0 until size) {
            ...
            if (character != null && ComponentsMapper.character.has(character as Entity)) {
                ...
                if ((aimingRestriction == null
                        || (isFlyer && aimingRestriction == com.gadarts.returnfire.ecs.systems.character.factories.AimingRestriction.ONLY_SKY)
                        || (!isFlyer && aimingRestriction == com.gadarts.returnfire.ecs.systems.character.factories.AimingRestriction.ONLY_GROUND))
