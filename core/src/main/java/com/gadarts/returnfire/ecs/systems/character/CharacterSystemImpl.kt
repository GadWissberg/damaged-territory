...
class CharacterSystemImpl(gamePlayManagers: GamePlayManagers) : CharacterSystem,
    ...
    private val characterSystemRelatedEntities = CharacterSystemRelatedEntities(gamePlayManagers.ecs.engine)
    ...
    private fun removeCharacterIfOnHangar(character: Entity) {
        ...
        for (hangar in characterSystemRelatedEntities.hangars) {
    ...
    private fun updateCharacters(deltaTime: Float) {
        for (character in characterSystemRelatedEntities.characters) {
            ...
            if (boardingComponent != null && boardingComponent.isBoarding() && TimeUtils.timeSinceMillis(
                ...
                boardingHandler.updateBoarding(character, deltaTime)
            } else {
